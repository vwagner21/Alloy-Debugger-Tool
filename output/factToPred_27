...
pred 	{ all f : Fence	| all disj l, l' : Location | l->l' in f_path <=> EdgeExists[f, l, f, l', uhb_intra] }
pred 	{ all r : Read 	| all disj l, l' : Location | l->l' in r_path <=> EdgeExists[r, l, r, l', uhb_intra] }
pred 	{ all w : Write	| all disj l, l' : Location | l->l' in w_path <=> EdgeExists[w, l, w, l', uhb_intra] }
